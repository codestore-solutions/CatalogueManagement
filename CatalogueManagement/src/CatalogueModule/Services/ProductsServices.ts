import {FeedbackToken, Ordertoken, Prodtoken} from '../../Constants/consts';
...
class ProductServices {
  ...
  //GET A URL for PRODUCT Feedback
  public static async getFeedbackURL(data: any) {
    console.log(data);
  ...
  public static async getWishlistdata(
    userID = '17175963-5b43-4e6b-a8d3-4c8d2f9fe4ed',
  ) {
    const res = await getApiData(
  ...
  public static async addToWishlists(
    userID = 5,
    prodId: number,
    wishListId: number,
    price: number,
